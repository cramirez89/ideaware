...
async function closeSession() {
  ...
  await new Promise(resolve => protocolInstance.Actions.session.call(protocolInstance, _protocol.default.SessionActions.DELETE, resolve));
...
async function handleQueueResult(err, resolve, reject) {
  ...
  if (client && client.api.screenshotsPath) {
    ...
    await (0, _screenshots.createFailureScreenshot)(client);
  }
